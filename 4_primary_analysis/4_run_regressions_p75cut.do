cap log close
log using "$log_path/4_run_regressions_p75cut_log.log", replace

/* This do-file runs 2SLS regressions using two log distance instruments (Table 8, column 8) */
...
* New instruments
local instr "log_mi_to_snf1 log_mi_to_snf2"
